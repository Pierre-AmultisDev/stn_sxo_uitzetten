 ...
 * Datum:    202409802
 * Versie:   005
 * Bestand:  retreive_all_documentinfo_BCT_tst.sql
...
, CASE
	WHEN SUBSTR(z.AANVRAAGNUMMER_STRING,1,2) = '20'
	   ...
	   ELSE ''
  END 
  AS SQUITXO_ZAAKNUMMER_AANGEPAST_B
...
, CASE
	WHEN SUBSTR(z.AANVRAAGNUMMER_STRING,1,2) = '20'
	   ...
	   ELSE ''
  END
  AS SQUITXO_ZAAKNUMMER_AANGEPAST_B_PUNT
...
, CASE
	WHEN (SUBSTR(z.AANVRAAGNUMMER_STRING,1,2) = '20') AND (SUBSTR(z.AANVRAAGNUMMER_STRING,5,1) = '2')
	   ...
	   ELSE ''
  END
  AS SQUITXO_ZAAKNUMMER_AANGEPAST_S
...
, d.*
, CASE
	WHEN TRIM(d.BESTANDSLOCATIE) = '-'
	   THEN 'NOT AVAILABLE'
	   ELSE 'E:\Apps\Apps\Squitxo\SquiXO Test\Documenten\' || d.DSS_ID
  END
  AS FULL_DOCUMENT_PATH
